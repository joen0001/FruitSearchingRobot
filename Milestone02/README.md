# FOR ASSESSMENT
1. enter slam & drive
2. save map by pressing 's' (should say map has saved)
3. go to files > G107_Intelligent_Robots > Milestone02 > lab_output > SLAM.txt
4. submit SLAM.txt file to moodle in under 20 minutes
