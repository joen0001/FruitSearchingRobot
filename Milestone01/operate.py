    ...
    def update_keyboard(self):
        for event in pygame.event.get():
            ...
            # turn left
                ...
                #self.command['motion'] = [-15, 15]
                # self.command['motion'] = [0, 5]
                self.command['motion'] = [0, 15] 
...
#                 if self.speed_var <= 10: self.speed_var = self.speed_var + 1
#                 else: self.speed_var = 10
                
#             # decrease speed
#             elif event.type == pygame.KEYDOWN and event.key == pygame.K_2:
#                 if self.speed_var >= 1: self.speed_var = self.speed_var - 1
#                 else: self.speed_var = 1
